...
To generate a composite of the co-polarization image navigate to the directory containing the unzipped RTC products and run this command.
```
make_composite composite.tif */*VV.tif
```

To generate a composite of the cross-polarization image navigate to the directory containing the unzipped RTC products and run this command.
```
