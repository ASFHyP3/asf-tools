...
products ([D. Small, 2012](https://doi.org/10.1109/IGARSS.2012.6350465)). It is intended to be used with products generated by ASF HyP3 (learn how to get RTC by [Using HyP3 in Vertex](https://hyp3-docs.asf.alaska.edu/using/vertex))

After requesting RTC Products for your area of interest, download and unzip them into an empty directory.


To get a composite of the dual vertical polarization image run this command in a directory containing the unzipped HyP3 Products.
```
make_composite composite.tif */*VV.tif
```

To get a composite of the cross polarized image run this command in a directory containing the unzipped HyP3 Products.
```
