...
def test_get_waterbody():
    ...
    test_mask = (
        "/vsicurl/https://hyp3-testing.s3.us-west-2.amazonaws.com/asf-tools/S1A_IW_20230228T120437_DVR_RTC30/"
...
def test_estimate_flood_depths_logstat(flood_window, hand_window):
    water_height = flood_map.estimate_flood_depth(
        1,
        hand_window,
        flood_window,
        estimator="logstat",
...
def test_make_flood_map(tmp_path):
    ...
    flood_map.make_flood_map(
        out_flood_map, vv_raster, water_raster, hand_raster, estimator="nmad"
    )
