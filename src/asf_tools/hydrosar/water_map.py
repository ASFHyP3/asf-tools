...
from asf_tools.hydrosar.threshold import (
    expectation_maximization_threshold as em_threshold,
)
...
def fuzzy_refinement(
    ...
    water_map_weights = (gaussian_membership + hand_membership + slope_membership + water_segment_membership) / 4.0
